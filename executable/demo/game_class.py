...
class Game():
    ...
    def __init__(self):
        ...
        # Main area
        background = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'main_area', 'main_area.png'))).convert_alpha()
        ...
        obt_image = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'main_area', 'obtainables', 'flashlight.png'))).convert_alpha()
        ...
        obt_image = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'main_area', 'obtainables', 'batteries.png'))).convert_alpha()
        ...
        # Warehouse entrance
        background = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'warehouse_entrance', 'warehouse_ent.png'))).convert_alpha()
        ...
        state1 = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'warehouse_entrance', 'not_obtainables', 'warehouse_door1.png'))).convert_alpha()
        state2 = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'warehouse_entrance', 'not_obtainables', 'warehouse_door2.png'))).convert_alpha()
        state3 = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'warehouse_entrance', 'not_obtainables', 'warehouse_door3.png'))).convert_alpha()
        ...
        # Departments
        background = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'departments', 'deptms.png'))).convert_alpha()
        ...
        # Not obtainables instances
        state1 = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'departments', 'not_obtns', 'MD_door1.png'))).convert_alpha()
        state2 = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'departments', 'not_obtns', 'MD_door2.png'))).convert_alpha()
        ...
        background = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'departments', 'materials', 'materials_dept.png'))).convert_alpha()

        materials_dept = scenario.Template(background, 'MATERIALS_DEPT')

        # Not obtainables (+ hidden obtainable)
        not_obt_image = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'departments', 'materials', 'not_obtns', 'docs.png'))).convert_alpha()
        obt_image = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'departments', 'materials', 'obtns', 'warehouse_key.png'))).convert_alpha()
        ...
        not_obt_image = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'departments', 'materials', 'not_obtns', 'pencils.png'))).convert_alpha()
        ...
        not_obt_image = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'departments', 'materials', 'not_obtns', 'dept_door.png'))).convert_alpha()
        ...
        # Buttons
        state1 = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'departments', 'materials', 'buttons', 'back_arrow1.png'))).convert_alpha()
        state2 = pygame.image.load(find_data_file(os.path.join('data', 'images', 'scenario', 'departments', 'materials', 'buttons', 'back_arrow2.png'))).convert_alpha()
    ...
    def process_events(self):
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                ...
                if self.current_scenario.black_screen == None or self.bag.flashlight_working:
